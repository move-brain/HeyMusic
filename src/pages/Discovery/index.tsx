...
import {  recommendPlaylist, topSong,topPlaylist,newAlbumlist , hotSinger } from '@/apis/discovery';
...
import type { RecommendPlaylistRes ,topPlaylistRes,newAlbumlistType,hotSingerType } from '@/apis/discovery';

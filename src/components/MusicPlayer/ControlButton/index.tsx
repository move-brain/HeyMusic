...
function ControlButton({ handlePlayOrPause } : Props) {
    ...
    return (
        <div className={style.container}>
            <ControlRorLButton type="left" handleChangeMusic={handleChangeMusic}  />
            <ControlMiddleButton  ClickButton={handlePlayOrPause} playState={isPlaying} />
            <ControlRorLButton type="right" handleChangeMusic={handleChangeMusic}  />
        </div>
    );
}
